/******/ (() => {
  ...
  \**********************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        const MovingObject = __webpack_require__(
          /*! ./moving_object */ "./lib/moving_object.js"
        );
  ...
  \*********************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        const Serpent = __webpack_require__(
          /*! ./serpent */ "./lib/serpent.js"
        );
        ...
        class Game {
          ...
          addCircles() {
            ...
            const possibleCircs = [
              40, 90, 140, 170, 185, 210, 250, 280, 310, 340, 370,
            ];
  ...
  \************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        const Circle = __webpack_require__(/*! ./circle */ "./lib/circle.js");
        const Block = __webpack_require__(/*! ./block */ "./lib/block.js");
        const SerpentNode = __webpack_require__(
          /*! ./serpent_node */ "./lib/serpent_node.js"
        );
        const Line = __webpack_require__(/*! ./line */ "./lib/line.js");
          ...
          draw(ctx) {
            ...
            for (let i = 0; i < this.length; i++) {
              ...
              if (i === 0) {
                ...
                prevPosX =
                  this.prevX[index] === undefined
                    ? this.pos[0]
                    : this.prevX[index];
                prevPosY = this.pos[1] + index;
                while (
                  Util.dist([prevPosX, this.pos[1] + index], this.mostPrev) < 21
                ) {
  ...
  \******************************/
    ...
    const GameView = __webpack_require__(
      /*! ./game_view */ "./lib/game_view.js"
    );
    const Util = __webpack_require__(/*! ./util */ "./lib/util.js");
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      document.getElementById("canvas-overlay").addEventListener(
        "click",
        function start() {
          started = true;
          document.getElementById("canvas-overlay").style.display = "none";
